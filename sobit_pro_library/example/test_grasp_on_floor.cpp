...
int main(int argc, char *argv[]) {
    ...
    // Pose: detecting_pose
    pro_joint_ctrl.moveToRegisterdMotion("detecting_pose");
    ...
    if (grasp_flag){
        ...
        pro_joint_ctrl.moveToRegisterdMotion("grasp_high_pose");
        ros::Duration(2.0).sleep();
    }

    // Pose: "initial pose"
    pro_joint_ctrl.moveToRegisterdMotion("initial_pose");
    ros::Duration(2.0).sleep();
